...
# -*- coding:utf-8 -*-
# author:LPE
# datetime:2020-02-27 15:52
# description:封装发送邮件的方法
    ...
    def send(self):
        ...
        try:
            ...
            try:
                ...
                self.log.info(f'发送邮件"{self.title}"成功! 收件人：{self.receiver}。如果没有收到邮件，请检查垃圾箱，同时检查收件人地址是否正确')
            finally:
                smtp_server.quit()  # 断开连接


if __name__ == '__main__':
    email = Email(server="smtp.126.com",
                  sender="***@126.com",
                  password="***",
                  receiver="***@qq.com",
                  title="医保慧控测试报告",
